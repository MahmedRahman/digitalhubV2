...
@section('title', 'تعديل صفحة اتصل بنا')
@section('page-title', 'تعديل صفحة اتصل بنا')
@section('page-description', 'عدّل محتوى صفحة اتصل بنا مباشرة')
...
<div class="editor-container" style="margin: -24px -32px; width: calc(100% + 64px); height: calc(100vh - 64px);">
    ...
    <div class="editor-topbar">
        <div class="flex items-center gap-4">
            <h2 class="text-lg font-heading font-bold text-textDark">محرر صفحة اتصل بنا</h2>
    ...
    <div class="editor-main">
        ...
        <div class="editor-content" id="contact-preview" style="min-height: 200px; background: #f0f0f0;">
            <!-- Hide navbar and footer in editor -->
            <style>
                #contact-preview nav,
                #contact-preview footer,
                #contact-preview [data-editor-hidden="true"] {
                    display: none !important;
                }
                
                /* Also hide navbar and footer if they're in the included content */
                #contact-preview header,
                #contact-preview .navbar,
                #contact-preview .footer {
                    display: none !important;
                }
            ...
            @include('contact', ['editor_mode' => true, 'content' => $content, 'isStandalone' => false])
        </div>
...
@push('scripts')
@vite(['resources/js/dashboard-contact-editor.js'])
@endpush
@endsection
