...
@section('page-description', 'أضف دورة تدريبية جديدة إلى المنصة')
    ...
    <div class="max-w-6xl">
        ...
        <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-6">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-bold text-blue-800 mb-3">الحقول المطلوبة لحفظ الدورة:</h3>
                    <div class="grid md:grid-cols-2 gap-3 text-sm text-blue-700">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-red-500 font-bold">*</span>
                            <span>المستوى (مبتدئ/متوسط/متقدم)</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="text-red-500 font-bold">*</span>
                            <span>المدة (مثال: 80 ساعة)</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="text-red-500 font-bold">*</span>
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-red-500 font-bold">*</span>
                            <span>الحالة (نشط/غير نشط)</span>
                        </div>
                    </div>
                    <p class="text-xs text-blue-600 mt-4">ملاحظة: الحقول الأخرى اختيارية ويمكن إضافتها لاحقاً</p>
                </div>
            </div>
        </div>
        
        <form method="POST" action="{{ route('dashboard.courses.store') }}" id="course-form" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                >
                                    ...
                                    <option value="مبتدئ" {{ old('level') == 'مبتدئ' ? 'selected' : '' }}>مبتدئ</option>
                                    <option value="متوسط" {{ old('level') == 'متوسط' ? 'selected' : '' }}>متوسط</option>
                                    <option value="متقدم" {{ old('level') == 'متقدم' ? 'selected' : '' }}>متقدم</option>
                                </select>
                                @error('level')
                                    <p class="mt-1 text-sm text-red-600 font-medium flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="form-tab" id="tab-overview">
                <div class="bg-white rounded-xl p-6 border-2 mb-6" style="border-color: #111111;">
                    ...
                    <div id="overview-container">
                        @if(old('course_overview'))
                            @foreach(old('course_overview') as $index => $overview)
            ...
            <div class="form-tab" id="tab-outline">
                <div class="bg-white rounded-xl p-6 border-2 mb-6" style="border-color: #111111;">
                    ...
                    <div id="outline-container">
                        @if(old('course_outline'))
                            @foreach(old('course_outline') as $sectionIndex => $section)
            ...
            <div class="form-tab" id="tab-target">
                <div class="bg-white rounded-xl p-6 border-2 mb-6" style="border-color: #111111;">
                    ...
                    <div id="target-container">
                        @if(old('who_is_this_for'))
                            @foreach(old('who_is_this_for') as $index => $target)
                                <div class="dynamic-item">
                                    <input 
                                        type="text" 
            ...
            <div class="form-tab" id="tab-trainers">
                <div class="bg-white rounded-xl p-6 border-2 mb-6" style="border-color: #111111;">
                    ...
                    <div id="trainers-container">
                        @if(old('trainers'))
                            @foreach(old('trainers') as $index => $trainer)
                                <div class="dynamic-item" style="background: #FFFFFF; border: 2px solid #04c2eb;">
                                    <div class="mb-4">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('final_cta_block.headline', 'ابدأ رحلتك في التعلم') }}" 
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                class="w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-primary transition-colors resize-none" 
                                style="border-color: #E5E7EB;"
                            >{{ old('final_cta_block.text', 'انضم إلى الكورس وابدأ في بناء مهاراتك العملية.') }}</textarea>
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('final_cta_block.button_text', 'سجل الآن') }}" 
...
<script>
    ...
    // Dynamic items
    let sectionIndex = {{ old('course_outline') ? count(old('course_outline')) : 0 }};
