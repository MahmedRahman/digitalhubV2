...
@section('page-description', 'عدل بيانات المقال')
...
@section('content')
    <div class="max-w-4xl">
        ...
        <form method="POST" action="{{ route('dashboard.blog.update', $post['id']) }}" class="space-y-6" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="flex items-center gap-4">
                            @if(isset($post['image']) && $post['image'])
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('storage/' . $post['image']) }}" alt="Current Image" class="w-32 h-32 object-cover rounded-lg border-2" style="border-color: #E5E7EB;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                id="read_time"
                                name="read_time" 
                                value="{{ old('read_time', $post['read_time'] ?? '5 دقائق') }}" 
